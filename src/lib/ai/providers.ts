...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  {
    ...
    customBaseURL: false,
    modelHint: 'gemini-2.5-flash, gemini-2.5-pro, gemini-3-flash ...',
  },
  {
    id: 'openrouter',
    type: 'openrouter',
    ...
    customBaseURL: false,
    modelHint: 'google/gemini-2.5-flash, openai/gpt-4o-audio-preview ...',
  },
  {
    id: 'zenmux',
    ...
    defaultModel: 'gemini-2.5-flash',
    customBaseURL: false,
    modelHint: 'gemini-2.5-flash, gpt-4o-audio-preview ...',
  },
  {
    id: 'custom',
    type: 'openai-compatible',
